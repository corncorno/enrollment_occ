                    ...
                    <div class="enrollment-card p-5">
                        ...
                        <form method="POST" action="" id="enrollmentForm">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="occ_examinee_number" name="occ_examinee_number"
                                           ...
                                           placeholder="Your OCC Examinee Number">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="father_education" class="form-label">Father's Highest Educational Attainment</label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="mother_education" class="form-label">Mother's Highest Educational Attainment</label>
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="permanent_address" name="permanent_address"
                                           ...
                                           placeholder="Building/House Number, Lot No., Street Name">
